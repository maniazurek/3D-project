...
In order to simulate the infinite bouncing of the balls, the @react-three/fiber and @react-three/cannon libraries were used.
The problem encountered was the placement of the balls in a circle, so the simulation was presented in a square instead.
